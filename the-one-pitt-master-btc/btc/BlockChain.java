...
//                for (Transaction trx : newBlock.transactions){
...
//                System.out.println(cetak);
    ...
    public static void addTransaction(Transaction newTrx){
        ...
        if (blockchain.size() == 1) {
            //jika aktif block belum di mining maka dia akan mining
            if (aktif == null) {
                aktif = new Block(getPreviousBlock().hash);
            }
        }
        if (aktif.nrofTrx() == 1) {
            addBlock(aktif);
