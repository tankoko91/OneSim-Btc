 ...
 *
 */
public class DistributedBubbleRapBtc 
				implements RoutingDecisionEngine, CommunityDetectionEngine
{
	 ...
	 */
	public DistributedBubbleRapBtc(Settings s)
	{
	 ...
	 */
	public DistributedBubbleRapBtc(DistributedBubbleRapBtc proto)
	{
	...
	public void doExchangeForNewConnection(Connection con, DTNHost peer)
	{
		...
		DistributedBubbleRapBtc de = this.getOtherDecisionEngine(peer);
	...
	public boolean shouldSendMessageToHost(Message m, DTNHost otherHost)
	{
		...
		DistributedBubbleRapBtc de = getOtherDecisionEngine(otherHost);
	...
	public boolean shouldDeleteSentMessage(Message m, DTNHost otherHost)
	{
		...
		DistributedBubbleRapBtc de = this.getOtherDecisionEngine(otherHost);
	...
	{
		DistributedBubbleRapBtc de = this.getOtherDecisionEngine(hostReportingOld);
		return de.commumesWithHost(m.getTo()) && 
			!this.commumesWithHost(m.getTo());
	}
	...
	{
		return new DistributedBubbleRapBtc(this);
	}
	...
	private DistributedBubbleRapBtc getOtherDecisionEngine(DTNHost h)
	{
		MessageRouter otherRouter = h.getRouter();
		assert otherRouter instanceof DecisionEngineRouter : "This router only works " + 
		" with other routers of same type";
		
		return (DistributedBubbleRapBtc) ((DecisionEngineRouter)otherRouter).getDecisionEngine();
	}
